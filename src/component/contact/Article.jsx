  ...
  return (
    <div className="w-full pb-10">
      <div className="w-[90%] mx-auto  mt-11  py-7   ">
        <div className="w-full  flex flex-col px-12 text-white  gap-4 ">
          ...
          <div className="w-full flex flex-wrap  items-start lg:items-center justify-start lg:justify-center gap-3 ">
            ...
            >
              <button className=" text-left  hover:bg-white all-colors hover:text-white font-semibold text-base lg:text-lg rounded-lg px-6 py-2 transition-all duration-300">
            ...
            >
              <button className=" hover:bg-white all-colors hover:text-white font-semibold text-base lg:text-lg rounded-lg  px-6 py-2 transition-all duration-300">
                Read LinkedIn Post
              </button>
            </NavLink>
            <NavLink
            ...
            >
              <button className="w-full px-6 hover:bg-white all-colors hover:text-white font-semibold text-base lg:text-lg rounded-lg py-2 transition-all duration-300">
