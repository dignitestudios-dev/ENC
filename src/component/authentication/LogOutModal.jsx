  ...
  return (
    logOutModal && (
      <div className="w-screen h-screen flex items-center justify-center bg-[rgba(0,0,0,0.4)] fixed top-0 left-0 right-0 bottom-0 z-30 px-4">
        <div className="bg-[#FFFFFF] backdrop-blur-[100px] w-[440px] py-10  rounded-[12px] ">
          <div className="flex items-start flex-col px-5 justify-center gap-y-4 h-full">
            <div  className="flex flex-col gap-y-2 items-start" >
              {/* <img src={Checkbox} alt="" /> */}
              <h3 className="text-2xl text-[#181818]" >Log Out</h3>
            </div>
          <p className="text-center text-wrap text-[#18181880]" >Are you sure you want to logout?</p>
